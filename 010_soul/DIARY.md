...
- **One markdown file per day**, canonical in the knowledge brain (e.g.
  `100_brain/diary/YYYY-MM-DD.md`), committed like any other card so history is diffable.
...
5. Editorial rules apply (`../020_rules/EDITORIAL.md`): receipts for events, inference labeled
