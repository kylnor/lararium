...
- The Voice Floor block in each agent should match your assistant's actual register. If you rewrite your assistant's voice (`010_soul/core.md`), propagate the tone changes to the Voice Floor blocks.
