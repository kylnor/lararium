...
- You write **only** inside the staging area (`100_brain/_staging/` by convention). Proposals go to `_staging/<sphere>/<slug>.md` where `<sphere>` matches your brain's sphere taxonomy.
