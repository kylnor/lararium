...
is to look at it *inside the lab* (`../060_lab/`, a disposable container) and never on the host. The
...
The wrapper is `060_lab/lab` in this stack (or wherever it was installed, check `060_lab/` at the stack
...
```bash
<stack>/060_lab/lab --analyze <source>
```
...
- **Go deeper:** `<stack>/060_lab/lab <source>` drops into an interactive offline shell in the box:
